...
// 얕은복사 문제점
// js에서 스프레드 사용시 1단계까지만 깊은복사
// 2단계부터는 참조값만 복사(얕은복사)
newProduct.option.color = "실버"; // 원본도 변경된다
product.price = 100000; // 1단계는 깊은복사라서 변경되지 않는다.
console.log(product); // 2단계부터는 얕은복사라서 실버로 변경됨.
console.log(newProduct); // newproduct의 price는 변경안됨(깊은복사)

...
const arr2 = new Array(3); // 3자리 만들어줘
console.log(arr2);
...
console.log(arr4[2]());  // arr4[2]함수, arr4[2](): 함수호출

// 추가
let fruits = ["사과", "오렌지", "체리"];
fruits.push("포도"); // 마지막 자리에 포도가 추가됨

// 삭제
// 마지막 index 데이터 꺼내옴
const grape = fruits.pop();
console.log(grape); // 마지막 idx꺼내왔다
...
// find(함수) -> 함수의 return결과가 true면 가져온다
...
// 블루베리 상함을 빼고,
// 그냥 블루베리를 refeidge에 추가 - 동일한 idx에 추가

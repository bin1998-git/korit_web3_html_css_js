    ...
    cell1.addEventListener("click", (event) => {
        console.log("cell1 리스너가 클릭감지");
        // click이벤트객체 < 브라우저가 만들어주는 객체
        console.log(event);
    ...
    const board = document.querySelector("#board");
        board.addEventListener("click", (event) => {
            console.log("보드판 리스너 클릭감지");
            console.log("실제내가 클릭한 요소:", event.target);
            console.log("이벤트 리스너가 붙어있는 요소:", event.currentTarget);
        });

...
// resolve : 비동기 작업이 성공했을떄 setter & promise의 state 변경
// reject : 비동기 작업이 실패했을떄 setter & promise의 state 변경
...
// promise 객체 리턴
a(10) // then -> promiseA의 상태가 fullfilled가 되었을떄 실행
    .then((resultA) => {
